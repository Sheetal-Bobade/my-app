                    ...
                    <div className="portfolio-wrap">
                        ...
                        <div className="portfolio-info">
                            ...
                            <div className="portfolio-links">
                                ...
                                <button className="portfolio-details-lightbox" onClick={togglePopup}><i className="bx bx-link"></i></button>
                             </div>
                        </div>
                    </div>
                </div>
    ...
    <div>
            {isOpen && (
                <div className="popup">
                    ...
                    <button onClick={togglePopup} className='popup-close'><i class="bi bi-x-lg"></i></button>
                    <PortfolioDetails />
                    </div>
                </div>
            )}
